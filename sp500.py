"""
Tickers del S&P 500 — snapshot desde Wikipedia (List of S&P 500 companies).
No es literalmente "todas las acciones del mercado" (eso son miles de
tickers, muchos ilíquidos, donde una estrategia de cruce de medias
funciona mal). Es el universo de las ~500 compañías más líquidas y
grandes de EE.UU. — mucho más amplio que 3 símbolos, y de calidad.

Esta lista puede quedarse desdesactualizada con el tiempo (el índice
cambia unos pocos nombres al año) — no es crítico para el bot, pero
si quieres, en algún momento la regeneramos.
"""

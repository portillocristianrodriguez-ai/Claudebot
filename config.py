...
class Config:
    ...
    # --- Universo de activos ---
    symbols_stocks: list[str] = field(default_factory=lambda: _get_list("SYMBOLS_STOCKS", "AAPL,MSFT,NVDA"))
    symbols_crypto: list[str] = field(default_factory=lambda: _get_list("SYMBOLS_CRYPTO", "BTC/USD,ETH/USD"))
